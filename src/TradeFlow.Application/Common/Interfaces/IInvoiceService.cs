...
public interface IInvoiceService
{
    ...
    Task<InvoiceDto> CreateInvoiceFromOrderAsync(int salesOrderId, TradeFlow.Domain.Enums.InvoiceType type = TradeFlow.Domain.Enums.InvoiceType.VatInvoice, List<InvoiceItemDto>? customItems = null, decimal? discountRate = null, CancellationToken cancellationToken = default);
