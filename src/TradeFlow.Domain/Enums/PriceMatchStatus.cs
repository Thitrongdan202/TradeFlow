...
public enum PriceMatchStatus
{
    ...
    /// <summary>Cần người dùng xem xét kiểm tra (chưa khớp chắc chắn hoặc có thay đổi sản phẩm)</summary>
    ReviewRequired = 2,

    /// <summary>Sản phẩm mới hoàn toàn (chưa có trong hệ thống)</summary>
    NewProduct = 3,

    /// <summary>Không xác định được sản phẩm (thiếu mã định danh hoặc tên)</summary>
    Unidentified = 4
}